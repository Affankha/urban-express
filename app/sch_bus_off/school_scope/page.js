...
<p>(lease of buses to schools):<br />
...
<h4 style={{color: "black"}}><GoSquareFill style={{color: "#00aab5"}}/>Customized Model (as per school requirement)</h4><br />
<p>(as per school requirement):<br />
